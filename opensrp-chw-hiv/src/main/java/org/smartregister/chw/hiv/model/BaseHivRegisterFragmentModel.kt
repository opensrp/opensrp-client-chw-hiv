...
import org.smartregister.chw.hiv.util.ConfigHelper.defaultRegisterConfiguration
...
open class BaseHivRegisterFragmentModel :
    BaseHivRegisterFragmentContract.Model {

    val hivLibrary by inject<HivLibrary>()

    override fun defaultRegisterConfiguration(): RegisterConfiguration? {
        return defaultRegisterConfiguration(hivLibrary.context.applicationContext())
    }
